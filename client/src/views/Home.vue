...
<template>
  <!-- Fundo animado ativo somente no modo escuro -->
  <div v-if="theme === 'dark'" style="position: fixed; top: 0; left: 0; width: 100vw; height: 100vh; z-index: -1;">
  ...
  <main :class="styles.main" style="min-height: 100vh; display: flex; flex-direction: column;">
    ...
    <template v-else>
      ...
      <section :class="styles.content" style="margin-bottom: 15rem;">
      ...
      <footer :class="styles.footer" style="margin-top: auto; flex-direction: row; justify-content: space-between; align-items: flex-end; padding: 2rem 1rem 1rem 1rem; border-top: 1px solid rgba(255,255,255,0.05); flex-wrap: wrap;">
        ...
        <div style="display: flex; flex-direction: column; gap: 0.5rem; align-items: flex-start; min-width: 150px; margin-top: 1rem;">
          ...
          <a href="https://downdetector.com.br/" target="_blank" title="Downdetector" style="display: flex; align-items: center; gap: 8px; color: var(--text-muted); text-decoration: none; font-size: 0.85rem; margin-bottom: 0.25rem; transition: color 0.2s;" onmouseover="this.style.color='var(--text-main)'" onmouseout="this.style.color='var(--text-muted)'">
