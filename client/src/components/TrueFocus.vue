...
<template>
  <div class="truefocus-container" ref="containerRef">
    ...
    >
      <span class="truefocus-corner corner-tl" :style="{ filter: 'drop-shadow(0 0 4px var(--border-color))' }"></span>
      <span class="truefocus-corner corner-tr" :style="{ filter: 'drop-shadow(0 0 4px var(--border-color))' }"></span>
      <span class="truefocus-corner corner-bl" :style="{ filter: 'drop-shadow(0 0 4px var(--border-color))' }"></span>
      <span class="truefocus-corner corner-br" :style="{ filter: 'drop-shadow(0 0 4px var(--border-color))' }"></span>
    </motion.div>
  </div>
</template>
